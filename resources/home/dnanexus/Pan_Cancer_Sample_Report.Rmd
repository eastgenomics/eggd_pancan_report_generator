...
datatable(metrics_filtered, rownames = F, rownames = F)
```
...
```{r}
datatable(rnaseqc_coverage_hgnc, editable = TRUE, rownames = F)
```
...
```{r}
datatable(rnaseqc_exonse_hgnc, editable = TRUE, rownames = F)
```
